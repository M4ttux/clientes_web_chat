...
<template>
    ...
    <form action="#" @submit.prevent="handleSubmit">
        <div class="mb-4">
            ...
            <textarea id="bio" class="w-full px-4 py-2 border border-gray-400 rounded" v-model="profile.bio"></textarea>
        </div>
        <div class="mb-4">
            <MainLabel for="display_name">Nombre:</MainLabel>
            <MainInput type="text" id="display_name" v-model="profile.display_name" />
        </div>
        <div class="mb-4">
            <MainLabel for="career">Carrera:</MainLabel>
            <MainInput type="text" id="career" v-model="profile.career" />
        </div>
